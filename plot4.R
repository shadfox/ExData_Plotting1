...
globalAct <- as.numeric(dataset$Global_active_power)
globalReact <- as.numeric(dataset$Global_reactive_power)
...
leg1 <- "Global Active Power"
leg2 <- "Voltage"
leg3 <- "Energy sub metering"
leg4 <- "Global_reactive_power"

png("plot4.png", width = 480, height = 480)
par(mfrow=c(2,2))

plot(dates, globalAct, type = "l", xlab = "", ylab = leg1)

plot(dates, volt, type="l", xlab = "datetime", ylab = leg2)

plot(dates, sub1, type="l", xlab = "", ylab = leg3)
...
plot(dates, globalReact, type="l", xlab = "datetime", ylab = leg4)
